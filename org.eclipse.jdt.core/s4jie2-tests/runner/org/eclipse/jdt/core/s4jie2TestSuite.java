...
public class s4jie2TestSuite {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    testCompile("invariants_resolve_error", false, "",
	    		"----------\n" + 
	    		"1. ERROR in /Users/bartj/s4jie2/eclipse.jdt.core/org.eclipse.jdt.core/s4jie2-tests/src/invariants_resolve_error.java (at line 16)\n" + 
	    		"	* @invar | 10 < true\n" + 
	    		"	           ^^^^^^^^^\n" + 
	    		"The operator < is undefined for the argument type(s) int, boolean\n" + 
	    		"----------\n" + 
	    		"2. ERROR in /Users/bartj/s4jie2/eclipse.jdt.core/org.eclipse.jdt.core/s4jie2-tests/src/invariants_resolve_error.java (at line 17)\n" + 
	    		"	* @invar | 10 < x\n" + 
	    		"	                ^\n" + 
